# Contributing to astro-compress-rs

Thank you for your interest in contributing to `astro-compress-rs`! We welcome contributions ranging from bug reports and documentation fixes to performance optimizations and new features.
...
`astro-compress-rs` is written in Rust. You will need:
...
```bash
git clone https://github.com/bhubbard/astro-compress-rs.git
cd astro-compress-rs
cargo build
```
